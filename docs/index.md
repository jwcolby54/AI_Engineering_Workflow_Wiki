...
- [CLAUDE.md Project Template](workflow-templates/CLAUDE_md_Project_Template.md) - project bootstrap for Claude Code
- [AGENTS.md Project Template](workflow-templates/AGENTS_md_Project_Template.md) - project bootstrap for Codex or other agent systems

### Templates
- [Workflow Record Template](AI_Workflow_Record_Template.md) - start every new engineering session from this
- [Workflow Record Update Instructions](AI_Workflow_Record_Update_Instructions.md) - how to update the record during a session
- [Decision Log Template](workflow-templates/Decision_Log_Template.md)
- [AI Handoff Template](workflow-templates/AI_Handoff_Template.md)

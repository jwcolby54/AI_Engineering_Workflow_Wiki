...
5. **Package the repository around adoption.**
   - Suggested top-level public structure:
     ...
     - `workflow-templates/` - workflow record and handoff templates.
...
- `governance/`, `concepts/`, and `workflow-templates/` define the operating protocol.
...
| `workflow-templates/AI_Workflow_Record_Template.md` | Starter record | No change / light edit | Preserve machine-readable structure. |
| `workflow-templates/AI_Workflow_Record_Update_Instructions.md` | Record maintenance | No change | Preserve update rules. |
| `workflow-templates/Decision_Log_Template.md` | Supporting template | No change / light edit | Include if still relevant. |
| `workflow-templates/AI_Handoff_Template.md` | Handoff template | No change / light edit | Include if still relevant. |
| `workflow-templates/CLAUDE_md_Project_Template.md` | Claude bootstrap | Light edit | Ensure public-safe defaults. |
| `workflow-templates/AGENTS_md_Project_Template.md` | Codex / agent bootstrap | Light edit | Ensure public-safe defaults. |
...
8. `workflow-templates/AI_Workflow_Record_Template.md` updated with a Human Clarification slot after AI_2 critique and timestamp fields at proposal, critique, clarification, revision, final review, scope freeze, and gate.
9. `workflow-templates/AI_Workflow_Record_Update_Instructions.md` rewritten with timestamp expectations for AI handoffs, Human clarification, scope freeze, gate approval, implementation, and validation.

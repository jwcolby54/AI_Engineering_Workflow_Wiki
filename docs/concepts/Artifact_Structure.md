...
|---|---|---|
| Claude Code | `CLAUDE.md` | [CLAUDE.md Project Template](../workflow-templates/CLAUDE_md_Project_Template.md) |
| OpenAI Codex | `AGENTS.md` | [AGENTS.md Project Template](../workflow-templates/AGENTS_md_Project_Template.md) |

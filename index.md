...
### Templates
- [Workflow Record Template](templates/AI_Workflow_Record_Template.md) - start every new engineering session from this
- [Workflow Record Update Instructions](templates/AI_Workflow_Record_Update_Instructions.md) - how to update the record during a session
